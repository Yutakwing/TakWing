...
The tracked activities are Reasoning Runner, the Clinical Readiness Lab, the Elbow, Ankle, Shoulder, Hip and Knee Goniometry Challenges, and the AI Literacy Check. Quiz answers, scores, age groups, roles, and other personal details are not sent to the Worker.
...
https://takwing-game-analytics.takwing-yu.workers.dev/stats?experience=knee-goniometry
```
