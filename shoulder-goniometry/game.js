...
function checkPlacement() {
  ...
  const tutorAdapter = window.SkillsTutorAdapters?.["shoulder-goniometry"];
  if (tutorAdapter) window.PhysioSkillsProgress?.recordFeedback("shoulder-goniometry", tutorAdapter(tutorBefore, tutorTarget, state, checkButton.disabled));
  render();
}
